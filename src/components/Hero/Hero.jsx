      ...
      <div className="h-full flex justify-center items-center p-4 bg-primary/10">
        <div className="container grid grid-cols-1 gap-4">
          ...
          <div
            data-aos="fade-up"
            data-aos-delay="600"
            className="space-y-4 bg-transparent rounded-md p-4 relative"
          >
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 py-3">
              <div>
                <label htmlFor="destination" className="opacity-90 text-white">
                  Search your Destination
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="destination" className="opacity-70 text-white">
                  Date
                </label>
                <input
                  type="date"
              ...
              <div>
                <label htmlFor="destination" className="opacity-70 block">
                  <div className="w-full flex justify-between items-center text-white">
                    <p>Max Price</p>
                    <p className="font-bold text-xl text-white">Rs. {priceValue}</p>
                  </div>
                </label>
